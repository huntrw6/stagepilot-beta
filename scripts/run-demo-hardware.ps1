...
$env:STAGEPILOT_PROPRESENTER_RECONNECT_INITIAL_SECONDS = "1"
$env:STAGEPILOT_PROPRESENTER_RECONNECT_MAX_SECONDS = "30"
$env:STAGEPILOT_PROPRESENTER_HEALTH_CHECK_SECONDS = "10"
