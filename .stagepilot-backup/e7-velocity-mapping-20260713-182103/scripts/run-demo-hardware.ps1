...
$env:STAGEPILOT_MIDI_START_NEXT_NOTE = "100"
$env:STAGEPILOT_MIDI_RESTART_CURRENT_NOTE = "101"
$env:STAGEPILOT_MIDI_PREVIOUS_NOTE = "102"
$env:STAGEPILOT_MIDI_NEXT_NOTE = "103"
$env:STAGEPILOT_MIDI_RELOAD_PLAN_NOTE = "104"
$env:STAGEPILOT_MIDI_STOP_TIMER_NOTE = "105"
